...
import { BitgetMarkPriceWsService } from "./bitget-markprice-ws.service";
...
@Module({
	...
	providers: [
		...
		BitgetClientService,
		BitgetWsService,
		BitgetMarkPriceWsService,
		PositionManagerService,
	],
	exports: [BotService, BitgetClientService, BitgetMarkPriceWsService, PositionManagerService],
})
